...
const Home = () => {
  ...
  return (
    <div className=" h-screen w-screen  lg:mx-auto  flex justify-center items-center flex-col">
      ...
      {/* Search  */}
      <div className="bg-white h-26 w-[90vw]  xl:w-[75vw]  lg:w-[82vw] h-10 flex justify-center items-center shadow-xl rounded-lg  mt-10 2xl:mt-28 md:mt-28">
        <div class="absolute  left-2 bottom- flex items-center pl-3 ml-2 rounded-lg">
          <FiSearch
            size={22}
            color="green"
            className="sm:ml-4 lg:ml-[4.5rem] xl:ml-42 2xl:ml-[10.9rem]"
          />
        </div>
        <input
          type="text"
