...
const Auth = () => {
  return (
    <div className="flex flex-col items-center  h-screen w-screen ">
      ...
      <div className="  sm:mt-10  md:mt-12  mt-14 w-[21rem] h-[20rem]  md:w-[23rem] md:h-[20rem] lg:w-[22rem] lg:h-[20rem] sm:w-[24rem] xl:h-[20rem] xl:w-[25rem]   bg-white shadow-lg rounded-lg flex flex-col items-center ">
